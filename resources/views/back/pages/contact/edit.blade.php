                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="work_hours" class="form-control @error('work_hours') is-invalid @enderror" value="{{ old('work_hours', $contact->work_hours) }}" required>
                                            @error('work_hours')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <div class="mt-2">
                                                <img src="{{ asset($contact->work_hours_image) }}" alt="" class="img-fluid" style="max-height: 100px">
                                            </div>
                                            @endif
                                        </div>
                                    </div>
