...
class BlogController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'slug_az' => 'required|string|max:255|unique:blogs,slug_az',
            'slug_en' => 'required|string|max:255|unique:blogs,slug_en',
            'slug_ru' => 'required|string|max:255|unique:blogs,slug_ru',
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = $request->validate([
            ...
            'title_en' => 'required|string|max:255',
            'title_ru' => 'required|string|max:255',
            'slug_az' => 'required|string|max:255|unique:blogs,slug_az,'.$id,
            'slug_en' => 'required|string|max:255|unique:blogs,slug_en,'.$id,
            'slug_ru' => 'required|string|max:255|unique:blogs,slug_ru,'.$id,
