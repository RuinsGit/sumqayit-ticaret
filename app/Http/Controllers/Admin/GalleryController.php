    ...
    public function update(Request $request, Gallery $gallery)
    {
        try {
            $request->validate([
                ...
                'main_image_alt_az' => 'nullable',
                'main_image_alt_en' => 'nullable',
                'main_image_alt_ru' => 'nullable',
                'bottom_image' => 'nullable|image|mimes:jpeg,png,jpg,gif',
                'bottom_image_alt_az' => 'nullable',
                'bottom_image_alt_en' => 'nullable',
                'bottom_image_alt_ru' => 'nullable',
                'bottom_images.*' => 'nullable|image|mimes:jpeg,png,jpg,gif',
            ]);
